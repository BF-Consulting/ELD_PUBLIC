 ...
 */
final class Version20221106191648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE resultat DROP INDEX UNIQ_E7DB5DE294078843, ADD INDEX IDX_E7DB5DE294078843 (acte_gestion_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE resultat DROP INDEX IDX_E7DB5DE294078843, ADD UNIQUE INDEX UNIQ_E7DB5DE294078843 (acte_gestion_id)');
    }
}
